...
def raw_data_processing():
    '''
    Ths function takes raw data and prepares the data for further modeling and analyses by appending all raw order files
    and merging products with departments and aisles information
    '''
    ...
    renames_orders= {'id_linea':'row_id',
                     'id_orden':'order_id',
    ...
    # Cretae unique id for order-product combination
    df['id_interaction'] = df['order_id'].astype(str) + '_' + df['product_id'].astype(str)
